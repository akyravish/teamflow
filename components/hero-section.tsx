...
import backgroundImage from '@/public/hero-background.webp';
						...
						<div className="mx-auto max-w-7xl px-6">
							<div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
								...
								<TextEffect
									...
									Tailflow organizes conversations into channels and threads, delivers real-time
									collaboration, and leverages AI to keep your team seamlessly in sync.
								</TextEffect>
